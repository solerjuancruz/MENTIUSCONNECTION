...
class FinCapacitacionController extends Controller
{
    /**
    ...
    public function update(Request $request, $id)
    {
        ...
        $horaInicio = \Carbon\Carbon::parse($tiempo->capacitacion);
        $horaFin = \Carbon\Carbon::parse($tiempo->capout);

        $tiempofinal = $horaInicio->diffInMinutes($horaFin);

        $tiempo->timecap = $tiempofinal;
