...
class FinDañoController extends Controller
{
    /**
    ...
    public function update(Request $request, $id)
    {
        ...
        $horaInicio = \Carbon\Carbon::parse($tiempo->daño);
        $horaFin = \Carbon\Carbon::parse($tiempo->dañoout);

        $tiempofinal = $horaInicio->diffInMinutes($horaFin);

        $tiempo->timedaño = $tiempofinal;
