...
class FinBañoController extends Controller
{
    /**
    ...
    public function update(Request $request, $id)
    {
        ...
        $horaInicio = \Carbon\Carbon::parse($tiempo->baño);
        $horaFin = \Carbon\Carbon::parse($tiempo->bañoout);
        
        $tiempofinal = $horaInicio->diffInMinutes($horaFin);

        $tiempo->timebaño = $tiempofinal;
