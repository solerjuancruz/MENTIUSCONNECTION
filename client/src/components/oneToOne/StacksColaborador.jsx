...
export default function StacksColaborador() {
  ...
  const data = {
    labels: ['Retroalimentacione', 'Positivas', 'Por mejorar', 'Por validar', 'Respuestas'],
    datasets: [
      {
        label:
        ...
        data: selectedColaborador !== null ? selectedColaborador.data : [0, 0, 0, 0, 0],
        backgroundColor: [
          'rgb(255, 99, 132)',
          'rgb(75, 192, 192)',
          'rgb(255, 205, 86)',
  ...
  return (
    <div className='dashboardOneToOneColaborador'>
      <div className='searchOneToOne'>
