...
export default function RechazosCreate({ onClose }) {
  ...
  return (
    <div className="containerMovistar" Name>
      <center>
        <img />
        <h3>RECHAZOS</h3>
      </center>
      <form onSubmit={formSubmit} className="form-horizontal" Name>
        <br />
          ...
          <div className="general-form">
            ...
            <div className="items-form">
              ...
              <select
                ...
                required
              >
                <option value="">Causales de Rechazo 1</option>
                <option value="">Causales de Rechazo 2</option>
              </select>
            </div>
            <div className="items-form">
            ...
            <div className="items-form">
              <label>Modalidad de Gestion</label>
            </div>
