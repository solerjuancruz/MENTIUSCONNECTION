...
export default function PortaTeleventasCreate( {onClose} ) {
  ...
  const formSubmit = async (event) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:8000/api/portateleventa",
        formData
      );
          ...
          <div className="general-form">
            ...
            <div className="items-form">
              ...
              <select
                ...
                required
              >
                <option>plan adq 1</option>
                <option>plan adq 2</option>
                <option>plan adq 3</option>
              </select>
            </div>
            <div className="items-form">
            ...
            <div className="items-form">
              <label htmlFor="likewize">LikeWize</label>
              <input
                type="file"
                id="likewize"
                name="likewize"
                className="form-control"
                placeholder="likewize"
                onChange={handleInputChange}
                value={formData.likewize}
              />
            </div>
            <div className="items-form">
