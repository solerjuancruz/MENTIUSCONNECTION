export default function FijaInboundEdit() {
    return (
                        ...
                        <div className="card">
                            <div className="card-body">
                                <form name="f1" action="{{ route('fijainbound.update', $fijas->id) }}" method="POST"
                                    ...
                                    <div className="container-movistar-fijainbound">
                                        <div className="general-form">
                                            ...
                                            <div className="items-form">
                                                <span>
                                                    <label for="confronta" style="color: black;">Confronta</label><br />
                                                    <a href="{{ asset('storage') . '/' . $fijas->confronta }}">
                                                        <img
                                                            src="{{ asset('storage') . '/' . $fijas->confronta }}" alt=""
                                                            height="130" width="300" style="border-radius: 10px" />
                                                    </a>
                                                </span>
                                            </div>
                                            <div className="items-form">
